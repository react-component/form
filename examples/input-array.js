...
function (_React$Component) {
  ...
  function Form() {
    ...
    _defineProperty(_assertThisInitialized(_this), "add", function () {
      ...
      var keys = form.getFieldValue('keys');
      keys = keys.concat(uuid); // can use data-binding to set
  ...
  _createClass(Form, [{
    ...
    value: function render() {
      ...
      var inputs = getFieldValue('keys').map(function (k) {
        ...
        }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("input", getFieldProps("name".concat(k))), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("a", {
          onClick: _this2.remove.bind(_this2, k)
        }, "delete"));
      });
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, inputs, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
        style: _styles__WEBPACK_IMPORTED_MODULE_3__["regionStyle"]
...
react_dom__WEBPACK_IMPORTED_MODULE_2___default.a.render(react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Form, null), document.getElementById('__react-content'));

/***/ }),

/***/ 6:
/*!***************************************!*\
  !*** multi ./examples/input-array.js ***!
  \***************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! ./examples/input-array.js */"./examples/input-array.js");
